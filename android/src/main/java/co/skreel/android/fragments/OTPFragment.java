package ng.techadvance.hashtagpayme.fragment;
...
import ng.techadvance.hashtagpayme.R;
import ng.techadvance.hashtagpayme.activity.AccountSetupActivity;
import ng.techadvance.hashtagpayme.activity.CreditCardSetupActivity;
import ng.techadvance.hashtagpayme.activity.SignupActivity;
import ng.techadvance.hashtagpayme.databinding.FragmentVerifyPhoneBinding;
import ng.techadvance.hashtagpayme.helper.InjectorUtils;
import ng.techadvance.hashtagpayme.helper.PrefUtils;
import ng.techadvance.hashtagpayme.helper.UIUtils;
import ng.techadvance.hashtagpayme.model.hashtag.CreateHashTagRequest;
import ng.techadvance.hashtagpayme.model.otp.OTPRequest;
import ng.techadvance.hashtagpayme.model.retrieve_user.AuthUser;
import ng.techadvance.hashtagpayme.viewmodels.auth.AuthViewModel;
import ng.techadvance.hashtagpayme.viewmodels.auth.AuthViewModelFactory;
...
//                    UIUtils.hideTransparentDialog();
    ...
    private void showShareIntent() {
        ...
        sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Join Me on #PayMe");
